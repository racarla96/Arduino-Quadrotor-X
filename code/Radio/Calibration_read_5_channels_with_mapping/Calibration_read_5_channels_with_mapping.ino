/*
   ...
   using Pin D8 to D12 for Channel 0 to 4
...
//Port definitions
#define FROMCHANNELPIN 8
#define TOCHANNELPIN 12
#define THROTTLE 10  // Additional remapping for throttle 0 to 1
...
void setup() {
  ...
  if (useFromEEPROM) {
    ...
    for (uint8_t i = FROMCHANNELPIN; i <= TOCHANNELPIN; i++) {
      ...
      if(i == THROTTLE) RC.setMap(channelMin, channelMax, i, 0, 1);   // Additional remapping for throttle
      else RC.setMap(channelMin, channelMax, i);
    }
